...
$conn = connect();
$categorie = 'Femme'; // Définir la catégorie Kids
$derniersProduitsFemme = getDerniersProduits('Femme');
$produitSpeciales= getProduitsOffreSpeciale('Femme');
$topProduits = getTopProduitsVendus('Femme');
...
.banner-slider {
  ...
  width: 400%; /* Adjust according to number of slides */
}
...
<div class="banner-slider-wrapper">
  ...
  <div class="banner-slider" id="bannerSlider">
    ...
    <div class="slide">Shop Now – Women's Collection</div>
  </div>
...
<section class="product-section" id="latest-products">
  ...
  <div class="product-grid">
    <?php foreach ($derniersProduitsFemme as $produit): ?>
  ...
  <div class="product-grid">
    <?php foreach ($topProduits as $produit): ?>
      ...
      <div class="product-card">
        ...
        <div class="product-info">
          <p class="product-name"><?= htmlspecialchars($produit['nom']); ?></p>
          <p class="product-price"><?= htmlspecialchars($produit['prix']); ?> DT</p>
...
<script>
  let bannerIndex = 0;
  const banners = document.querySelectorAll('.banner-slider-sports .slidefemme');
